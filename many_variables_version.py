                            ...
                            if operate1 not in ['+', '-', 'x', '/'] :
                                ...
                                if operate2 not in ['+', '-', 'x', '/'] :
                                    ...
                                    try :
                                        ...
                                        print(f"The result of the operation : {number1}{operate1}{number2}{operate1}{number2} = {result5}")
                                    except ValueError :
                                        print(f"Enter a numeric value")
                    ...
                    #I add while True before each input, in order to ask the user to try again, if the entered value is not valid
                        ...
                        if choice2 == 'trigo' : 
                            ...
                            if choice3 == 'TF' :
                                ...
                                result2 = calculator_two(np.radians(number), operate)
                                ...
                                number = float(input(f"- Enter a number of your choice n : "))
                                result3 = calculator_two(number, operate)
                            ...
                            number = float(input(f"- Enter a number of your choice n : "))
                            result4 = calculator_two(number, operate)
